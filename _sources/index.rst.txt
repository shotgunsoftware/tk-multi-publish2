Flow Production Tracking Publisher API reference, |release|
###########################################################
...
interface. These items represent what the artists may want to track in
Flow Production Tracking and/or share with other artists by way of publishing.
Similarly, as files are dragged and dropped onto the publish UI, they are
processed and collected as publish items. This item collection behavior is
defined by the app's collector hook and can be taken over or modified by
studios to customize what data should be tracked in Flow Production Tracking
and how it should be shared between artists.
