...
class Ui_ProgressDetailsWidget(object):
    def setupUi(self, ProgressDetailsWidget):
        ...
        self.open_log_button = QtGui.QToolButton(self.progress_frame)
        self.open_log_button.setToolButtonStyle(QtCore.Qt.ToolButtonTextOnly)
        self.open_log_button.setObjectName("open_log_button")
        self.horizontalLayout.addWidget(self.open_log_button)
    ...
    def retranslateUi(self, ProgressDetailsWidget):
        ...
        self.open_log_button.setToolTip(QtGui.QApplication.translate("ProgressDetailsWidget", "<html><head/><body><p>Open the publisher\'s log file. The log file is useful for deeper debugging of publish issues. For issues involving Shotgun Support, please include a copy of this file when submitting a support request. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.open_log_button.setText(QtGui.QApplication.translate("ProgressDetailsWidget", "Open log file...", None, QtGui.QApplication.UnicodeUTF8))
