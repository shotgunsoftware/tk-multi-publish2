...
"}")
        ...
        self.drop_area_browse_file = QtGui.QPushButton(self.large_drop_area)
        self.drop_area_browse_file.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.drop_area_browse_seq = QtGui.QPushButton(self.large_drop_area)
        ...
        self.horizontalLayout_4.addWidget(self.drop_area_browse_seq)
        ...
        spacerItem8 = QtGui.QSpacerItem(179, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_2.addItem(spacerItem8, 1, 2, 1, 1)
        spacerItem9 = QtGui.QSpacerItem(20, 213, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 82, 26))
        ...
        spacerItem10 = QtGui.QSpacerItem(20, 558, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/browse.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/trash.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.delete_items.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/expand.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.expand_all.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/contract.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.collapse_all.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/help.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        spacerItem11 = QtGui.QSpacerItem(10, 10, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/cross.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.stop_processing.setIcon(icon8)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.drop_area_browse_file.setText(QtGui.QApplication.translate("Dialog", "Browse files to publish     ", None, QtGui.QApplication.UnicodeUTF8))
