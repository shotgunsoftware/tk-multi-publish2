...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.items_tree_stack = QtGui.QStackedWidget(self.frame)
        self.items_tree_stack.setObjectName("items_tree_stack")
        ...
        self.items_tree_label = QtGui.QLabel(self.page)
        self.items_tree_label.setObjectName("items_tree_label")
        self.verticalLayout_15.addWidget(self.items_tree_label)
        ...
        self.items_tree_stack.addWidget(self.page)
        ...
        self.reversed_items_tree_label = QtGui.QLabel(self.page_2)
        self.reversed_items_tree_label.setObjectName("reversed_items_tree_label")
        self.verticalLayout_14.addWidget(self.reversed_items_tree_label)
        self.reversed_items_tree = QtGui.QTreeWidget(self.page_2)
        self.reversed_items_tree.setObjectName("reversed_items_tree")
        self.reversed_items_tree.headerItem().setText(0, "1")
        self.reversed_items_tree.header().setVisible(False)
        self.verticalLayout_14.addWidget(self.reversed_items_tree)
        self.items_tree_stack.addWidget(self.page_2)
        self.verticalLayout_2.addWidget(self.items_tree_stack)
        ...
        self.widget = QtGui.QWidget(self.details_summary)
        self.widget.setObjectName("widget")
        self.horizontalLayout_2 = QtGui.QHBoxLayout(self.widget)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.summary_icon = QtGui.QLabel(self.widget)
        ...
        self.summary_header = QtGui.QLabel(self.widget)
        ...
        self.widget1 = QtGui.QWidget(self.details_summary)
        self.widget1.setGeometry(QtCore.QRect(17, 100, 341, 325))
        ...
        self.context_stack = QtGui.QStackedWidget(self.widget1)
        self.context_stack.setObjectName("context_stack")
        self.context_display = QtGui.QWidget()
        self.context_display.setObjectName("context_display")
        self.horizontalLayout_9 = QtGui.QHBoxLayout(self.context_display)
        ...
        self.summary_context = QtGui.QLabel(self.context_display)
        self.summary_context.setObjectName("summary_context")
        self.horizontalLayout_3.addWidget(self.summary_context)
        self.summary_context_edit = QtGui.QToolButton(self.context_display)
        self.summary_context_edit.setObjectName("summary_context_edit")
        self.horizontalLayout_3.addWidget(self.summary_context_edit)
        self.horizontalLayout_9.addLayout(self.horizontalLayout_3)
        self.context_stack.addWidget(self.context_display)
        self.context_input = QtGui.QWidget()
        self.context_input.setObjectName("context_input")
        self.horizontalLayout_8 = QtGui.QHBoxLayout(self.context_input)
        self.horizontalLayout_8.setSpacing(0)
        self.horizontalLayout_8.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.summary_context_select = GlobalSearchWidget(self.context_input)
        self.summary_context_select.setObjectName("summary_context_select")
        self.horizontalLayout_8.addWidget(self.summary_context_select)
        self.context_stack.addWidget(self.context_input)
        self.formLayout.setWidget(0, QtGui.QFormLayout.FieldRole, self.context_stack)
        self.label_2 = QtGui.QLabel(self.widget1)
        self.label_2.setObjectName("label_2")
        self.formLayout.setWidget(1, QtGui.QFormLayout.LabelRole, self.label_2)
        self.summary_thumbnail = Thumbnail(self.widget1)
        ...
        self.formLayout.setWidget(1, QtGui.QFormLayout.FieldRole, self.summary_thumbnail)
        self.label_3 = QtGui.QLabel(self.widget1)
        self.label_3.setObjectName("label_3")
        self.formLayout.setWidget(2, QtGui.QFormLayout.LabelRole, self.label_3)
        self.summary_comments = QtGui.QPlainTextEdit(self.widget1)
        self.summary_comments.setObjectName("summary_comments")
        self.formLayout.setWidget(2, QtGui.QFormLayout.FieldRole, self.summary_comments)
        ...
        self.items_tree_stack.setCurrentIndex(0)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.reversed_items_tree_label.setText(QtGui.QApplication.translate("Dialog", "Publish Settings", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.summary_context_edit.setText(QtGui.QApplication.translate("Dialog", "...", None, QtGui.QApplication.UnicodeUTF8))
