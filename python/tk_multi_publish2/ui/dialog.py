...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/browse_white.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        spacerItem6 = QtGui.QSpacerItem(179, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_2.addItem(spacerItem6, 1, 2, 1, 1)
        spacerItem7 = QtGui.QSpacerItem(20, 213, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        self.settings_stack = QtGui.QStackedWidget(self.details_task)
        self.settings_stack.setObjectName("settings_stack")
        self.builtin_settings_page = QtGui.QWidget()
        self.builtin_settings_page.setObjectName("builtin_settings_page")
        self.verticalLayout_14 = QtGui.QVBoxLayout(self.builtin_settings_page)
        self.verticalLayout_14.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_14.setObjectName("verticalLayout_14")
        self.scrollArea_2 = QtGui.QScrollArea(self.builtin_settings_page)
        ...
        self.task_settings_label = QtGui.QLabel(self.builtin_settings_page)
        self.task_settings_label.setObjectName("task_settings_label")
        self.verticalLayout_14.addWidget(self.task_settings_label)
        self.task_settings = SettingsWidget(self.builtin_settings_page)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.settings_stack.addWidget(self.custom_settings_page)
        self.verticalLayout_11.addWidget(self.settings_stack)
        ...
        self.details_please_select_tasks_of_same_type = QtGui.QWidget()
        self.details_please_select_tasks_of_same_type.setObjectName("details_please_select_tasks_of_same_type")
        self.verticalLayout_15 = QtGui.QVBoxLayout(self.details_please_select_tasks_of_same_type)
        self.verticalLayout_15.setObjectName("verticalLayout_15")
        self.label_2 = QtGui.QLabel(self.details_please_select_tasks_of_same_type)
        self.label_2.setObjectName("label_2")
        self.verticalLayout_15.addWidget(self.label_2)
        self.details_stack.addWidget(self.details_please_select_tasks_of_same_type)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/browse.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/trash.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/expand.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/contract.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/help.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/cross.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.large_drop_area_label.setText(QtGui.QApplication.translate("Dialog", "Drag and drop files here", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("Dialog", "Or, if you prefer...", None, QtGui.QApplication.UnicodeUTF8))
        self.drop_area_browse.setToolTip(QtGui.QApplication.translate("Dialog", "Browse files to publish", None, QtGui.QApplication.UnicodeUTF8))
        self.drop_area_browse.setText(QtGui.QApplication.translate("Dialog", "Browse files to publish", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_2.setText(QtGui.QApplication.translate("Dialog", "Please only select tasks of the same type.", None, QtGui.QApplication.UnicodeUTF8))
