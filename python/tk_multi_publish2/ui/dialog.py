...
"}")
        ...
        self.builtin_details_task = QtGui.QWidget()
        self.builtin_details_task.setObjectName("builtin_details_task")
        self.verticalLayout_11 = QtGui.QVBoxLayout(self.builtin_details_task)
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.horizontalLayout_4 = QtGui.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.task_icon = QtGui.QLabel(self.builtin_details_task)
        ...
        self.task_name = QtGui.QLabel(self.builtin_details_task)
        ...
        self.scrollArea_2 = QtGui.QScrollArea(self.builtin_details_task)
        ...
        self.task_settings_label = QtGui.QLabel(self.builtin_details_task)
        self.task_settings_label.setObjectName("task_settings_label")
        self.verticalLayout_11.addWidget(self.task_settings_label)
        self.task_settings = SettingsWidget(self.builtin_details_task)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.details_stack.addWidget(self.builtin_details_task)
        self.custom_details_task = QtGui.QWidget()
        self.custom_details_task.setObjectName("custom_details_task")
        self.verticalLayout_15 = QtGui.QVBoxLayout(self.custom_details_task)
        self.verticalLayout_15.setObjectName("verticalLayout_15")
        self.custom_plugin_ui = QtGui.QWidget(self.custom_details_task)
        self.custom_plugin_ui.setObjectName("custom_plugin_ui")
        self.verticalLayout_16 = QtGui.QVBoxLayout(self.custom_plugin_ui)
        self.verticalLayout_16.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_16.setObjectName("verticalLayout_16")
        self.verticalLayout_15.addWidget(self.custom_plugin_ui)
        self.details_stack.addWidget(self.custom_details_task)
