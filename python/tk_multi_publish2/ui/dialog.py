...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_2 = QtGui.QLabel(self.details_tab)
        self.label_2.setGeometry(QtCore.QRect(15, 30, 101, 20))
        self.label_2.setObjectName("label_2")
        self.plainTextEdit = QtGui.QPlainTextEdit(self.details_tab)
        self.plainTextEdit.setGeometry(QtCore.QRect(10, 60, 381, 141))
        ...
        self.settings_scroll = QtGui.QScrollArea(self.settings_tab)
        self.settings_scroll.setWidgetResizable(True)
        self.settings_scroll.setObjectName("settings_scroll")
        self.settings_widget = QtGui.QWidget()
        self.settings_widget.setGeometry(QtCore.QRect(0, 0, 376, 403))
        self.settings_widget.setObjectName("settings_widget")
        self.settings_layout = QtGui.QVBoxLayout(self.settings_widget)
        self.settings_layout.setObjectName("settings_layout")
        spacerItem = QtGui.QSpacerItem(20, 376, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.settings_layout.addItem(spacerItem)
        self.settings_scroll.setWidget(self.settings_widget)
        self.verticalLayout_7.addWidget(self.settings_scroll)
        ...
        spacerItem1 = QtGui.QSpacerItem(638, 11, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(QtGui.QApplication.translate("Dialog", "Context: xxxxx", None, QtGui.QApplication.UnicodeUTF8))
