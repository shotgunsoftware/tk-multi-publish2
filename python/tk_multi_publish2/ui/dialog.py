...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.reload.setMinimumSize(QtCore.QSize(20, 0))
        self.reload.setMaximumSize(QtCore.QSize(20, 16777215))
        self.reload.setText("")
        self.reload.setObjectName("reload")
        self.horizontalLayout.addWidget(self.reload)
        self.swap = QtGui.QPushButton(self.bottom_frame)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/tk_multi_publish2/yinyang.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.swap.setIcon(icon)
