...
class Ui_ProgressWidget(object):
    def setupUi(self, ProgressWidget):
        ...
        ProgressWidget.resize(696, 358)
        self.verticalLayout = QtGui.QVBoxLayout(ProgressWidget)
        self.verticalLayout.setObjectName("verticalLayout")
        self.progress_frame = QtGui.QFrame(ProgressWidget)
    ...
    def retranslateUi(self, ProgressWidget):
        ...
        self.progress_label.setText(QtGui.QApplication.translate("ProgressWidget", "Progress Details", None, QtGui.QApplication.UnicodeUTF8))
