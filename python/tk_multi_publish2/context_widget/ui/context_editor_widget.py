...
class Ui_ContextWidget(object):
    def setupUi(self, ContextWidget):
        ...
        self.context_menu_btn.setFocusPolicy(QtCore.Qt.NoFocus)
        self.context_menu_btn.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.context_search_btn.setFocusPolicy(QtCore.Qt.NoFocus)
        icon1 = QtGui.QIcon()
